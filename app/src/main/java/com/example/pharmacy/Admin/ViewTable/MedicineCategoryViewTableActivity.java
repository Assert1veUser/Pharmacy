...
public class MedicineCategoryViewTableActivity extends AppCompatActivity {
    private ActivityMedicineCategoryViewTableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMedicineCategoryViewTableBinding.inflate(getLayoutInflater());
        ...
        Thread gfgThread = new Thread(new Runnable() {
            ...
            public void run() {
                try  {
                    ...
                    ResultSet resultSet = statement.executeQuery("SELECT * FROM medicine_category ORDER BY id ASC;");
        ...
        try {
            ...
            TableLayout tableLayout = (TableLayout) findViewById(binding.tableLayoutMedicineCategoryViewTable.getId());
